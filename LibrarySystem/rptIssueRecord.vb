...
Public Class rptIssueRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibrarySystem.rptIssueRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIssueRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIssueRecord = New rptIssueRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
