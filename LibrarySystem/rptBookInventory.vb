...
Public Class rptBookInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibrarySystem.rptBookInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookInventory = New rptBookInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
