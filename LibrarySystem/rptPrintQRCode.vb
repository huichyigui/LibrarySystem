...
Public Class rptPrintQRCode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibrarySystem.rptPrintQRCode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintQRCode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintQRCode = New rptPrintQRCode()
        rpt.Site = Me.Site
        Return rpt
    End Function
