...
Public Class rptBookMasterlist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibrarySystem.rptBookMasterlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookMasterlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookMasterlist = New rptBookMasterlist()
        rpt.Site = Me.Site
        Return rpt
    End Function
